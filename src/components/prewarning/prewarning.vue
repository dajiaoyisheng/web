...
<style lang="stylus">
  font-size=12px //定义变量
  @import '../../css/base.styl' .input-w line-height 40px @extends .clearfix .label float left width 120px .input-item padding-left 10px height 32px width 320px border 1px solid #ddd border-radius 5px
